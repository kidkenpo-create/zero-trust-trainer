window.ZTT_MODULES = [
  {
    ...
    selfPacedGuide: {
      ...
      starterSteps: [
        ...
        "Draft a short operational decision in the learner response field.",
      ...
      sections: {
        ...
        response: {
          ...
          action: "Write two to five focused sentences. Include what is untrusted, what compensating control you will use, and what you will monitor.",
